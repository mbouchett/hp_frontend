...
if(!function_exists("create_square_image")){
	function create_square_image($original_file, $destination_file=NULL){
		...
		if($original_width > $original_height) $square_size = $original_width;
		...
		$smaller_image = imagecreatetruecolor($square_size, $square_size);
...
create_square_image("corn.jpg","sample_corn.jpg",500);
?>
