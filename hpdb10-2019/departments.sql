...
(227, 'Seasonal Candle Holders', 41, 4, 0),
(106, 'Shower Curtains', 14, 4, 0),
(1000, 'Table Lamps', 26, 2, 0),
(108, 'Jewelry Accessories & Charms', 45, 4, 0),
(109, 'Scarves', 15, 4, 0),
(110, 'Bar Stools', 16, 2, 0),
(111, 'Dining Furniture Top Floor', 16, 2, 0),
(112, 'Furniture Hardware & Accessories', 16, 2, 0),
(114, 'Poufs', 16, 2, 3),
(115, 'Floor Screens & Room Dividers', 16, 2, 0),
(116, 'Doormats', 17, 2, 7),
...
(1001, 'Floor Lamps', 26, 2, 0),
(211, 'Desk Chairs', 3, 3, 0),
(212, 'Desks', 3, 3, 0),
(214, 'Cleaning', 4, 3, 0),
...
(1008, 'Tapestries', 31, 2, 0),
(1009, 'Throw Blankets', 31, 2, 0),
(1010, 'Sheets', 31, 2, 0),
...
--
ALTER TABLE `departments`
  MODIFY `dept_ID` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1013;
COMMIT;
