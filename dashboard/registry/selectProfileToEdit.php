<?php
//selectProfileToEdit.php 2018/06
...
<html>
<head>
	<title>Homeport Registry Profile Editor</title>
	<style type="text/css">
		td{
...
<body>
<br />
<h2>Homeport Registry Profile Editor</h2>
...
<table>
  ...
  ?>
	<tr>
		<td align="center">
  			<a href="editRegProfile.php?regnum=<?=stripslashes($reg[$i]['reg_ID'])?>">
