...
<body >
	...
	<table class="order">
		...
		<tr>
			...
			<td><span style="font-size: 16px; font-weight: bold; background-color: #00FF00; font-family: Arial"><?= $vendor['vendor_name'] ?> (<?= $vendor['vendor_rep'] ?>)</span></td>
		</tr>
...
<table class="wantlist">
    <tr>
        <td colspan="4" class="wantTitle">
        <?= $wantcount ?> Wantlist&#40;s&#41; Associated With This Vendor
        </td>
    </tr>
...
<?php } ?>
	...
	<table class="order">
		...
		<tr>
			<td><b><span style="font-family: Arial; font-size: 24px"><a href="sentOrders.php" style="text-decoration: none; color: #000000">Homeport</a></span></b></td>
			<td><span style="font-size: 16px; font-weight: bold; background-color: #b3ffb3; font-family: Arial"><?= $vendor['vendor_name'] ?> (<?= $vendor['vendor_rep'] ?>)</span></td>
		</tr>
		<tr><td>52 Church Street</td><td><?= $vendor['vendor_addr1'] ?></td></tr>
		<tr><td>Burlington, VT 05401</td><td><?= $vendor['vendor_addr2'] ?></td></tr>
		<tr><td></td><td><?= $vendor['vendor_addr3'] ?></td></tr>
	...
	<table class="order">
		<tr><td>Order</td><td>Sku</td><td>Description</td><td>Cost</td><td>Cat</td><td style="text-align: right;">Retail</td></tr>
		<tr><td colspan="6" height="1" bgcolor="#767676"></td></tr>
	<?php } } ?>
	</table>
	<br />
<table class="order">
    ...
    -------------------------------------------------------------------------------------------------------------------------<br />
    [ ] I put the wantlist items on hold and updated Customer Service<br />
    [ ] I attached the packing list<br />
    [ ] I put the items on the shelf and backstocked the extra<br />
    [ ] I Received this in the system<br />
    (Yes) (No) I attached an Exception Report<br />
    (Yes) (No) I created a Backorder<br />
