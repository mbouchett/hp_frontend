<?php
//uncalled.php 2018/01
// Display cs items that have been received but the customer has not been contacted
...
$ii=0;
for($i=0; $i<$listCount; $i++){
 if(!$items[$i]['ci_datecontacted'] && !$items[$i]['ci_datepickedup']){
   $goodlist[$ii]=$items[$i];
   $ii=$ii+1;
 }
}
...
<head>
  <title>Uncalled Wantlists</title>
</head>
<body>
...
<?php
if($goodCount < 1) { ?>
<div style="font-family: Arial; font-weight: Bold; font-size: 24px" align="center">No Uncalled Found<br />
