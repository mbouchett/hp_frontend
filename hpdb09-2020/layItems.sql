...
(274, 217, 5, 'Slat Crates', 2, '-11.99'),
(275, 224, 20, 'THC Vases 29364 Brown Rust', 2, '27.99'),
(276, 224, 9, 'Sake Set', 1, '51.99'),
(277, 224, 18, 'Palladium Pillow', 2, '28.79'),
(278, 224, 18, 'Taya Lumbar Jute', 1, '15.99'),
(279, 224, 18, 'Taya Lumbar Charcoal', 1, '15.99'),
(282, 225, 16, 'Keen ', 1, '51.66'),
(283, 227, 18, 'Papasan Standard USA', 1, '149.00'),
(284, 229, 16, 'Modern Media Console 58', 1, '291.66'),
(285, 230, 16, 'Artisans Craft Accent Table Weathered White	', 1, '141.75'),
(286, 232, 28, 'Newton Sleeper Sofa Chantel Avocado', 1, '374.25'),
(287, 233, 16, 'Natures Edge Light Chestnut Cocktail Table', 1, '279.00'),
(289, 235, 28, 'Grayson Caramel Chair and Ottoman', 1, '863.88');
...
--
ALTER TABLE `layItems`
  MODIFY `li_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=290;
COMMIT;
